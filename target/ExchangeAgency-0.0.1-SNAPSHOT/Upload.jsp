...
<html>
<head>
    <title>Cart - E-commerce Exchange Agency</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <c:if test="${not empty listAgency}">
            <div class="item-grid">
                    ...
                    <div class="item-card">
                        <a href="productDetails?id=<c:out value='${agency.id}' />">
                            ...
                            <div class="info">
                                ...
                                <p>Brand: <c:out value="${agency.brand}" /></p>
                            </div>
                        </a>
                        <div class="actions">
                            <a href="edit?id=<c:out value='${agency.id}' />" class="edit">Edit</a>
        ...
        <c:if test="${empty listAgency}">
            <p class="empty-message">No items found.</p>
        </c:if>
    </div>
    <div class="footer">
        &copy; 2024 E-commerce Exchange Agency. All rights reserved.
    </div>
</body>
</html>
